...
import reflection.ufoships.EnemyShipFactory;
import reflection.ufoships.UFOEnemyShip;
...
public class TestingReflection {
	...
	public static void main(String[] args){
		...
		System.out.println("getModifiers:" + Modifier.isPublic(classModifiers) + "\n");
		...
		for(Method method : classMethods){
			...
			for(Class parameter : parameterType){
				...
				System.out.println("parameter_name:" + parameter.getName());
		...
		for(Class parameter : constructParameters){
			...
			System.out.println("constructParameterName:" + parameter.getName());
